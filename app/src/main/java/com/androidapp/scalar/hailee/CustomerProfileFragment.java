...
public class CustomerProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button mLogOutBtn = (Button) view.findViewById(R.id.customerLogoutBtn);
        LinearLayout nameTxt = (LinearLayout) view.findViewById(R.id.customer_name_txt);
        LinearLayout emailTxt = (LinearLayout) view.findViewById(R.id.customer_email_txt);
        LinearLayout mobNumTxt = (LinearLayout) view.findViewById(R.id.customer_mobnum_txt);
        LinearLayout pwTxt = (LinearLayout) view.findViewById(R.id.customer_pw_txt);

        mLogOutBtn.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    CustomerMapActivity.isLoggingOut = true;
